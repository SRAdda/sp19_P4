...
# SQL statement
$sql = "select categoryID, categoryName from sp19_newscategories";
/*
$sql = 
"
...
$config->titleTag = 'News Categories';
...
{#records exist - process
	...
	{# process each row
        ...
        echo '
            <tr>
              <th scope="row"><a href="' . VIRTUAL_PATH . 'news/feed_list.php?id=' . (int)$row['categoryID'] . '">' . dbOut($row['categoryName']) . '</a></th>
            </tr>
        ';
